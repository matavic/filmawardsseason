...
let AppComponent = class AppComponent {
    constructor(router, awardService) {
        this.router = router;
...
let AwardComponent = class AwardComponent {
    constructor(route, awardService, modalService, ngxLoader) {
        this.route = route;
        this.awardService = awardService;
    ...
    ngOnInit() {
        ...
        this.awardDescription = _awards_awards__WEBPACK_IMPORTED_MODULE_5__["awards"].find((a) => a.title === this.award).description;
        this.awardImage = _awards_awards__WEBPACK_IMPORTED_MODULE_5__["awards"].find((a) => a.title === this.award).image;
        this.awardDate = _awards_awards__WEBPACK_IMPORTED_MODULE_5__["awards"].find((a) => a.title === this.award).date;
    ...
    open(content, movie) {
        ...
        this.awardService.getMovie(movie).subscribe((data) => {
            this.movie = data;
    ...
    openTrailerModal(videoId) {
        this.ngxLoader.startLoader("loader-movie");
        const modalRef = this.modalService.open(_trailer_modal_trailer_modal_component__WEBPACK_IMPORTED_MODULE_8__["TrailerModalComponent"], { backdropClass: 'custom-backdrop', centered: true, size: 'xl', windowClass: 'dark-modal' });
...
let AwardService = class AwardService {
    ...
    getMovie(movie) {
        const options = { params: new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpParams"]().set('m', movie) };
        return this.http.get(`${_environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].apiUrl}movie`, options);
    }
    search(term) {
        const options = { params: new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpParams"]().set('t', term) };
    ...
    predictive(term) {
        const options = { params: new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpParams"]().set('search', term) };
        if (term === '') {
...
let CategoryComponent = class CategoryComponent {
    ...
    ngOnInit() {
        ...
        this.categoryDescription = _categories_categories__WEBPACK_IMPORTED_MODULE_5__["categories"].find((a) => a.title === this.category).description;
        this.movies$ = this.awardService.getMoviesByCategory(_map_categories__WEBPACK_IMPORTED_MODULE_6__["mapCategories"].get(this.category))
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_10__["tap"])(data => {
            for (let i = 0; i < data.length; i++)
                this.ngxLoader.startLoader(String(i));
        }));
        this.ngxLoader.stop();
    ...
    openTrailerModal(videoId) {
        this.ngxLoader.startLoader("loader-movie");
        const modalRef = this.modalService.open(_trailer_modal_trailer_modal_component__WEBPACK_IMPORTED_MODULE_9__["TrailerModalComponent"], { backdropClass: 'custom-backdrop', centered: true, size: 'xl', windowClass: 'dark-modal' });
        let url = `https://www.youtube.com/embed/${videoId}?controls=0&autoplay=1`;
        modalRef.componentInstance.videoId = url;
        this.ngxLoader.stopLoader("loader-movie");
    }
...
let LoadedDirective = class LoadedDirective {
    constructor(elRef) {
        this.elRef = elRef;
...
LoadedDirective.ctorParameters = () => [
...
let ResultsComponent = class ResultsComponent {
    constructor(route, router, awardService, modalService, ngxLoader) {
        this.route = route;
        this.router = router;
        this.awardService = awardService;
        this.modalService = modalService;
    ...
    openTrailerModal(videoId) {
        this.ngxLoader.startLoader("loader-movie");
        const modalRef = this.modalService.open(_trailer_modal_trailer_modal_component__WEBPACK_IMPORTED_MODULE_7__["TrailerModalComponent"], { backdropClass: 'custom-backdrop', centered: true, size: 'xl', windowClass: 'dark-modal' });
        let url = `https://www.youtube.com/embed/${videoId}?controls=0&autoplay=1`;
        modalRef.componentInstance.videoId = url;
        this.ngxLoader.stopLoader("loader-movie");
    }
...
let PresentationStatisticComponent = class PresentationStatisticComponent {
    constructor(route, awardService, ngxLoader, router) {
        this.route = route;
        this.awardService = awardService;
        this.ngxLoader = ngxLoader;
        this.router = router;
...
PresentationStatisticComponent.ctorParameters = () => [
    { type: _angular_router__WEBPACK_IMPORTED_MODULE_2__["ActivatedRoute"] },
    { type: _award_award_service__WEBPACK_IMPORTED_MODULE_3__["AwardService"] },
...
let SelectionStatisticComponent = class SelectionStatisticComponent {
    constructor(router) {
        this.router = router;
        this.selectedAward = "";
    }
...
SelectionStatisticComponent.ctorParameters = () => [
    { type: _angular_router__WEBPACK_IMPORTED_MODULE_3__["Router"] }
];
...
let TrailerModalComponent = class TrailerModalComponent {
...
TrailerModalComponent.ctorParameters = () => [
